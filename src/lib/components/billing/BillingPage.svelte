<script lang="ts">
  ...
  import { Check, Star, Zap, CreditCard, Settings } from "@lucide/svelte";
...
<Tabs defaultValue="subscriptions" class="space-y-6">
  <TabsList class="grid w-full grid-cols-2">
    <TabsTrigger value="subscriptions" class="flex items-center gap-2">
      <Star class="h-4 w-4" />
      Subscriptions
    </TabsTrigger>
    <TabsTrigger value="credits" class="flex items-center gap-2">
  ...
  <TabsContent value="credits" class="space-y-6">
    <div class="mb-6">
      <h2 class="text-2xl font-semibold mb-2">Credit System</h2>
      <p class="text-muted-foreground">
        Purchase credits for pay-as-you-go usage. Credits never expire and can be used for any AI model or feature.
      </p>
    </div>
